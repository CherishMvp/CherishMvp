        ...
        <el-form-item prop="sex"
          ...
          <el-select class="select-sex"
            ...
            <el-option label="男"
                       value="man"></el-option>
            <el-option label="女"
                       value="woman"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button type="primary"
                     @click="updateUserData('form')">确定</el-button>
...
export default {
  ...
  methods: {
    ...
    // 	const self = this;
    // 	let username = sessionStorage.getItem('ms_username').name;
    // 	self.$http.get('/api/user/login',{name: username}).then(function(response) {
